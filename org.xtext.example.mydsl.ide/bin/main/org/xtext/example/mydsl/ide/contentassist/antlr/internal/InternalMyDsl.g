...
:
	(
		...
		(
			{ before(grammarAccess.getImportAccess().getImportURISectionFQNParserRuleCall_1_0_1()); }
			ruleFQN
			{ after(grammarAccess.getImportAccess().getImportURISectionFQNParserRuleCall_1_0_1()); }
		)
